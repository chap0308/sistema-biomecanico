...
- disponibilidad de los puntos anatómicos clave necesarios;
- presencia de oclusiones críticas;
- integridad temporal de la ejecución;
- estabilidad de la estimación de pose.
...
|---|---|---|---|---|---|
| 2026-07-24 | Población, muestreo e Instrumento 1 | La condición de apoyo será verificada manualmente. No se implementará detección automática de soportes ni del contacto talón-suelo. | Trasladado a la redacción metodológica y al Instrumento 1 | No se añade una regla computacional de descarte por elevación del talón | Aplicado |
| 2026-07-24 | Marco teórico, matriz de operacionalización, 8.5, 8.6 e Instrumento 2 | El indicador numérico se define como promedio de 13 puntos anatómicos clave detectados por fotograma con visibilidad mínima de 0,5. | Trasladado al Word, a la matriz de operacionalización y al Instrumento 2 | No cambia el cálculo actual; formaliza su significado | Aplicado |
| 2026-07-25 | Unidad de análisis, control de calidad, Instrumentos 2 y 3 y análisis de datos | La unidad evaluable es una repetición completa. La muestra formal mantiene 75 videos y recomienda una repetición por video, mientras que el sistema admite una o varias ejecuciones por archivo. | Precisar que cada repetición recibe sus propias variables, clasificaciones y evaluación experta; eliminar el consenso entre repeticiones | F1-score y Kappa se calculan sobre pares repetición-patrón. La consolidación entre expertos se conserva para cada par, sin mezclar ejecuciones | Aplicado en el sistema; pendiente de traslado manual a la versión formal si el asesor lo solicita |
